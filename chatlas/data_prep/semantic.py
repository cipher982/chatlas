...
# Constants
DEFAULT_SEMANTIC_PATH = Path("./data/sample/location_history/semantic/2023")
DEFAULT_OUTPUT_PATH = Path("./data/sample/processed/semantic.pkl")
...
def main():
    data = load_data_from_files(DEFAULT_SEMANTIC_PATH)
